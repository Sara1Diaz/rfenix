                    ...
                    <div className="fila">
                        <div className="row">
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                        <img src="../img/caballeros/adidas/Tarjeta 1/lado 1.jpeg" className="card-img-top" alt="..." /> 
                                        <h5>ZAPATILLAS BOOST</h5>
                                        <p className="card-text" />
                                        <a href="/AdidasCaballeros1" className="btn btn-primary">Ver detalles</a> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                        <img src="../img/caballeros/adidas/Tarjeta 2/lado 1 .png" className="card-img-top" alt="..." />
                                        <h5>TENIS FORUM LOW</h5>
                                        <p className="card-text" />
                                        <a href="/AdidasCaballeros2" className="btn btn-primary">Ver detalles</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                        <img src="../img/caballeros/adidas/Tarjeta 3/lado 1.png" className="card-img-top" alt="..." />
                                        <h5>TENIS GRAND COURT</h5>
                                        <p className="card-text" />
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                        <img src="../img/caballeros/adidas/Tarjeta 4/lado 1.png" className="card-img-top" alt="..." />
                                        <h5>TENIS ADVANTAGE</h5>
                                        <p className="card-text" />
                                        <a href="/AdidasCaballeros4" className="btn btn-primary">Ver detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
