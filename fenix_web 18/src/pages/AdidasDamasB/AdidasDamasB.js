                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    ...
                                    <img src="../img/damas/adidas/TENIS HOOPS 3.0 BOLD/angulo.png" className="card-img-top" alt="..." />

                                        <h5>TENIS HOOPS 3.0 BOLD</h5>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/adidas/TENIS FORUM BONEGA/1.png" className="card-img-top" alt="..." />
                                        <h5>TENIS FORUM BONEGA</h5>
                                        <p className="card-text" />
                                        <a href="/adidasdamas2" className="btn btn-primary">Ver detalles</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/adidas/TENIS CONTINENTAL VULC/1.png" className="card-img-top" alt="..." />
                                        <h5>TENIS CONTINENTAL VULC</h5>
                                        <p className="card-text" />
                                        <a href="/adidasdamas3" className="btn btn-primary">Ver detalles</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/adidas/TENIS OZGAIA/1.png" className="card-img-top" alt="..." />
                                        <h5>TENIS OZGAIA</h5>
                                        <p className="card-text" />
                                        <a href="/adidasdamas4" className="btn btn-primary">Ver detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
