...
function FilaCaballerosj() {
    ...
    const exportToExcel = () => {
        ...
        if (confirmExport) {
            ...
            saveAs(data, 'ProductosFilaCaballeros.xlsx');
        }
    };
    ...
    const exportToPDF = () => {
        ...
        if (confirmExport) {
            ...
            doc.text("Productos Fila Caballeros", 14, 15);
            doc.autoTable({
                head: [tableColumn],
                body: tableRows,
                startY: 20,
            ...
            doc.save('ProductosFilaCaballeros.pdf');
        }
    };
...
export default FilaCaballerosj;
