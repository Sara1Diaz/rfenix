                ...
                <div className="col-md-10">
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    ...
                                    <img src="../img/damas/fila/TRACTOR/1.PNG" className="card-img-top" alt="..." />
                  <h5>TRACTOR</h5>
                  <p className="card-text" />
                  <a href="/filadamas1" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/fila/Tenis Sneakers Dp21/frontal.png" className="card-img-top" alt="..." />
                  <h5>Tenis Sneakers Dp21</h5>
                  <p className="card-text" />
                  <a href="/filadamas2"className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/fila/Fila Euskadi/alfrente.png" className="card-img-top" alt="..." />
                  <h5>Fila Euskadi</h5>
                  <p className="card-text" />
                  <a href="/filadamas3" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/fila/Fila Ray Tracer/2.png" className="card-img-top" alt="..." />
                  <h5>Fila Ray Tracer </h5>
                  <p className="card-text" />
                  <a href="/filadamas4" className="btn btn-primary">ver detalles</a>
