...
import './JordanDamasB.css'; // Importa el archivo CSS

function JordanDamasB() {
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    ...
                                    <img src="../img/damas/jordan/Strawberries  Cream/derecho.PNG" className="card-img-top" alt="..." /> 
                                    <h5>Strawberries  Cream</h5>
                                    <p className="card-text"></p>
                                    <a href="/jordandamas1"className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/jordan/Mid Arctic Rosado/1.png" className="card-img-top" alt="..." /> 
                                    <h5>Mid Arctic Rosado</h5>
                                    <p className="card-text"></p>
                                    <a href="/jordandamas2" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/jordan/Bright Citrus Bright/lado derecho.JPEG" className="card-img-top" alt="..." /> 
                                    <h5> Bright Citrus Bright </h5>
                                    <p className="card-text"></p>
                                    <a href="/jordandamas3" className="btn btn-primary">ver detalles</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/jordan/Air Jordan 1 Mid/1.PNG" className="card-img-top" alt="..." /> 
                                    <h5>Air Jordan 1 Mid</h5>
                                    <p className="card-text"></p>
                                    <a href="/jordandamas4"className="btn btn-primary">ver detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
