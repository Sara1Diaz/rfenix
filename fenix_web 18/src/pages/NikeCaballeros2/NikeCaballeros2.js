    ...
    <div className="container">
      ...
      <div className="content">
        <div className="carousel-container">
          ...
          >
            <div>
              <img src="../img/caballeros/nike/Tarjeta 2/lado 1.png"alt="Imagen 1" className="carousel-image" />
            </div>
            <div>
              <img src="../img/caballeros/nike/Tarjeta 2/lado 2.png" alt="Imagen 2" className="carousel-image" />
            </div>
            <div>
              <img src="../img/caballeros/nike/Tarjeta 2/lado 3.png" alt="Imagen 3" className="carousel-image" />
            </div>
        ...
        <div className="details">
          ...
          <div className="description">
            ...
            <p className="description-content">Este nuevo modelo de nike se destaca por su simplicidad y comodidad</p>
          </div>
