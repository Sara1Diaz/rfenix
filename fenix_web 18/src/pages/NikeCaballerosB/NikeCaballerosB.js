...
import './NikeCaballerosB.css'; // Importa el archivo CSS

function NikeCaballerosB() {
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    ...
                                    <img src="../img/caballeros/nike/Tarjeta 1/lado 1.png"  className="card-img-top" alt="..." />
                  <h5>Nike Air Force</h5>
                  <p className="card-text" />
                  <a href="/nikecaballeros1"  className="btn btn-primary">ver detalles</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/caballeros/nike/Tarjeta 2/lado 1.png"className="card-img-top" alt="..." />
                  <h5>Nike SB Dunk Low</h5>
                  <p className="card-text" />
                  <a href="/nikecaballeros2"  className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/caballeros/nike/Tarjeta 3/lado 1.png"className="card-img-top" alt="..." />
                  <h5>Nike Air Force</h5>
                  <p className="card-text" />
                  <a href="/nikecaballeros3"  className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/caballeros/nike/Tarjeta 4/lado 1.png" className="card-img-top" alt="..." />
                  <h5>Nike Dunk Low</h5>
                  <p className="card-text" />
                  <a href="/nikecaballeros4"  className="btn btn-primary">ver detalles</a>
...
export default NikeCaballerosB;