...
function NikeCaballerosj() {
    ...
    const exportToExcel = () => {
        ...
        if (confirmExport) {
            ...
            saveAs(data, 'ProductosNikeCaballeros.xlsx');
            mostrarAlerta('Archivo Excel exportado correctamente.');
        }
    };
    ...
    const exportToPDF = () => {
        ...
        if (confirmExport) {
            ...
            doc.text("Productos Nike Caballeros", 14, 15);
            doc.autoTable({
                head: [tableColumn],
                body: tableRows,
                startY: 20,
            ...
            doc.save('ProductosNikeCaballeros.pdf');
            mostrarAlerta('Archivo PDF exportado correctamente.');
        }
    };

    const mostrarAlerta = (mensaje) => {
        alert(mensaje); // Muestra una alerta simple
    };
                ...
                <div className="col-md-15 contenedor-tarjetas d-flex align-items-center justify-content-center">
                    <table className="table">
                        ...
                        <tbody>
                            ...
                            {/* Fila para mostrar el total de la cantidad disponible */}
                            <tr>
                                <td colSpan="6"></td>
...
export default NikeCaballerosj;
