        ...
        <form onSubmit={handleActualizarProducto}>
            ...
            <div className="col-md-15 contenedor-tarjetas d-flex align-items-center justify-content-center">
                <div className="col-md-10">
                  ...
                  <h5>DUNK LOW PRO SB 'TWEED</h5>
                  <p className="card-text" />
                  <a href="/nikedamas1" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/nike/nike retro/lado izquierdo.jpeg" className="card-img-top" alt="..." />
                  <h5>NIKE RETRO</h5>
                  <p className="card-text" />
                  <a href="/nikedamas2" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/nike/Nike SB Dunk Low/al frente.jpeg" className="card-img-top" alt="..." />
                  <h5>Nike SB Dunk Low</h5>
                  <p className="card-text" />
                  <a href="/nikedamas3" className="btn btn-primary">ver detalles</a>
                            ...
                            <div className="col-sm-6 mb-3 mb-sm-0">
                                <div className="card">
                                    <div className="card-body">
                                    <img src="../img/damas/nike/Nike Vomero/lado derecho.jpeg" className="card-img-top" alt="..." />
                  <h5>Nike Vomero </h5>
                  <p className="card-text" />
                  <a href="/nikedamas4" className="btn btn-primary">ver detalles</a>
                                    </div>
                                </div>
                            </div>
                        </div>
