...
import './NikeDamasj.css'; // Importa el archivo CSS
...
function NikeDamasj() {
    ...
    const exportToExcel = () => {
        ...
        if (confirmExport) {
            ...
            saveAs(data, 'ProductosNikeDamas.xlsx');
    ...
    const exportToPDF = () => {
        ...
        if (confirmExport) {
            ...
            doc.text("Productos Nike Damas", 14, 15);
            doc.autoTable({
                head: [tableColumn],
                body: tableRows,
                startY: 20,
            ...
            doc.save('ProductosNikeDamas.pdf');
